...
// app.use(authenticateToken); // temporarily disabled for local dev so /admin and assets load without auth
...
let mailOptions = (error) => {
  return {
    ...
    to: "chittaranjan.ghoshal@gmail.com",
    subject: "Error Log",
    text: error,
  };
};
...
process.on("uncaughtException", function (err) {
  ...
  // sendMail(mailOptions(err)); // disabled for local dev to avoid external SMTP timeouts
});
