...
const sendAddAdpEmail = (name, email, adpId, password) => {
  let options = {
    ...
    text: `Namaste ${name} ji!
      ...
      https://www.experience.iloveimpact.com/adp
      ...
      Exclusive cashback, awards, rewards and food vouchers are waiting for you. Please check details about Tea Leaf Loyalty Program by clicking link below,
      
      www.iloveimpact.com/tealeaf
    
      You can call us on 9940593793 or visit our office any time you need.
